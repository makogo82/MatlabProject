...
shot = load('shot_37416.mat'); %dati cluster
disp('Caricamento Psi_Density_Gamma');
psiDensityGammaLoad=load([ 'Psi_Density_Gamma' num2str(37416) '.mat']);
psiDensityGamma=psiDensityGammaLoad.Psi_Density_Gamma;
densityMis = psiDensityGamma.density.data;
positionMis = psiDensityGamma.density.x;
sizePosMis=size(positionMis,2);
