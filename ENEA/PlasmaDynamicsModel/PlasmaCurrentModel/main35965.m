...
plot(time,IplFilter,...
     dITFilter.Time', -dITFilter.Data'*25.7720 - 17*dIVFilter.Data',...
     dITFilter.Time', -dITFilter.Data'*25.7720 - 0*dIVFilter.Data')
legend('IPmis','IPsim, ThetaV=17','IPsim, ThetaV=0')
