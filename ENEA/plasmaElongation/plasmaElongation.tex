...
The plasma elongation $k$ is defined as the ratio between the vertical and horizontal plasma length.\\
There are a quesi-static relationship between the elongation $k$ and the current $I_F$ of the form
\begin{equation}
	k = f(I_F)
\end{equation}
which can be approximated by the map 
\begin{equation}
	{k_{appr}} = k_0 - k_1 \frac{I_F}{I_P} 
\end{equation}
which is affine in $I_F$. $I_F$ is the current of active coil F, $I_P$ is the plasma current, $k_0 = 1.03$ and $k_1 = -4.61$.\\
...
\frame{\frametitle{Plasma elongation. Shots 35965, 36569, 36574 and 36634}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.8\linewidth]{figs/b1.eps}
...
\frame{\frametitle{Plasma elongation. Shots 35965, 36569, 36574 and 36634}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.8\linewidth]{figs/b2.eps}
		\caption[Shots 38864, 38865 and 38869]{Shots 38864, 38865 and 3886}
		\label{fig:correlazioneIfIp3581335819}
	\end{figure}
...
\frame{\frametitle{38513, 38519}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.8\linewidth]{figs/c1.eps}
...
\frame{\frametitle{38513, 38519}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.8\linewidth]{figs/c2.eps}
		\caption[Shot 38513 and 38519]{Shot 38513 and 38519.}
		\label{fig:correlazioneIfIp3581335819}
	\end{figure}		
}
...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{figs/a1.eps}
\caption[Shots 38864, 38865 and 38869]{Shots 38864, 38865 and 3886. Vertical instability.}
\label{fig:correlazioneIfIp3581335819}
\end{figure}
...
\frame{\frametitle{38864, 38865 and 38869}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.8\linewidth]{figs/a2.eps}
		\caption[Shots 38864, 38865 and 38869]{Shots 38864, 38865 and 3886. Vertical instability.}
		\label{fig:correlazioneIfIp3581335819}
	\end{figure}
